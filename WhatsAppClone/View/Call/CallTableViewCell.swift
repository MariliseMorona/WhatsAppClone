...
class CallTableViewCell: UITableViewCell {
    ...
    static let identifier = "CallTableViewCell"
    ...
    lazy var stackViewUser : UIStackView = {
        let stack = UIStackView(arrangedSubviews: [labelTitle, labelStatus])
    ...
    lazy var stackViewHour : UIStackView = {
        let stack = UIStackView(arrangedSubviews: [labelDate, imgInfo])
        stack.translatesAutoresizingMaskIntoConstraints = false
    ...
    private func constraints(){
        NSLayoutConstraint.activate([
            ...
            stackViewHour.topAnchor.constraint(equalTo: stackViewUser.topAnchor, constant: 10),
            stackViewHour.leadingAnchor.constraint(equalTo: stackViewUser.trailingAnchor, constant: 10),
            stackViewHour.bottomAnchor.constraint(equalTo: stackViewUser.bottomAnchor, constant: -10),
